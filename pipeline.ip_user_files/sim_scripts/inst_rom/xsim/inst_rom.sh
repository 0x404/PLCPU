...
xv_boost_lib_path=D:/Vivado/Vivado/2019.2/tps/boost_1_64_0
xvlog_opts="--relax"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_rom xil_defaultlib.inst_rom xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Vivado/Vivado/2019.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
